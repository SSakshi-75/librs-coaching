        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-block bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-4 py-1.5">
              <span className="text-brand-orange font-semibold text-sm uppercase tracking-wider">★ Trusted by 5000+ Students</span>
            </div>

            <h1 className="text-5xl md:text-6xl font-extrabold leading-tight">
              Shape Your Future with <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-orange to-yellow-400">Librs Classes</span>
            </h1>

            <p className="text-lg text-gray-300 max-w-lg leading-relaxed">
              Experience world-class education with expert faculty, comprehensive study materials, and a proven track record of outstanding results in competitive exams.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link to="/faculty" className="bg-brand-orange hover:bg-brand-orange-hover text-white px-8 py-3 rounded-full font-bold text-lg transition-transform transform hover:-translate-y-1 shadow-lg shadow-orange-500/30 text-center">
                Explore Courses
              </Link>
              <Link to="/contact" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/30 text-white px-8 py-3 rounded-full font-bold text-lg transition-transform transform hover:-translate-y-1 text-center">
                Apply for Admission
              </Link>
            </div>
          </motion.div>
